...
#basic flight control
    ...
    def confirmConnection(self):
        ...
        if server_ver < server_min_ver:
            ...
            print("Colosseum server is of older version and not supported by this client. Please upgrade!")
        elif client_ver < client_min_ver:
            print(ver_info, file=sys.stderr)
            print("Colosseum client is of older version and not supported by this server. Please upgrade!")
        else:
            print(ver_info)
        print('')
    ...
    def simSwapTextures(self, tags, tex_id = 0, component_id = 0, material_id = 0):
        ...
        See https://codexlabsllc.github.io/Colosseum/retexturing/ for details
...
#image_type uses one of the ImageType members
    def simGetImage(self, camera_name, image_type, vehicle_name = '', external = False):
        ...
        See https://codexlabsllc.github.io/Colosseum/image_apis/ for details
...
#image_type uses one of the ImageType members
    def simGetImages(self, requests, vehicle_name = '', external = False):
        ...
        See https://codexlabsllc.github.io/Colosseum/image_apis/ for details and examples
...
#End CinemColosseum     
    ...
    def simRunConsoleCommand(self, command):
        ...
        Allows the user to create bespoke APIs very easily, by adding a custom event to the level blueprint, and then calling the console command "ce MyEventName [args]". No recompilation of Colosseum needed!
...
#gets the static meshes in the unreal scene
    def simGetMeshPositionVertexBuffers(self):
        ...
        See https://codexlabsllc.github.io/Colosseum/meshes/ for details and how to use this
    ...
    def simSetObjectScale(self, object_name, scale_vector):
        ...
        Args:
            ...
            scale_vector (colosseum.Vector3r): Desired scale of object
    ...
    def simSpawnObject(self, object_name, asset_name, pose, scale, physics_enabled=False, is_blueprint=False):
        ...
        Args:
            ...
            pose (colosseum.Pose): Desired pose of object
            scale (colosseum.Vector3r): Desired scale of object
    ...
    def simSetSegmentationObjectID(self, mesh_name, object_id, is_name_regex = False):
        ...
        See https://codexlabsllc.github.io/Colosseum/image_apis/#segmentation for details

        Args:
            mesh_name (str): Name of the mesh to set the ID of (supports regex)
            object_id (int): Object ID to be set, range 0-255

                             RBG values for IDs can be seen at https://codexlabsllc.github.io/Colosseum/seg_rgbs.txt
    ...
    def simGetSegmentationObjectID(self, mesh_name):
        ...
        Mapping of Object IDs to RGB values can be seen at https://codexlabsllc.github.io/Colosseum/seg_rgbs.txt
...
#Add new vehicle via RPC
    ...
    def getSettingsString(self):
        """
        Fetch the settings text being used by Colosseum
...
#low - level control API
    ...
    def setAngleLevelControllerGains(self, angle_level_gains=AngleLevelControllerGains(), vehicle_name = ''):
        ...
        - Modifying these gains will also affect the behaviour of moveByVelocityAsync() API.
            This is because the Colosseum flight controller will track velocity setpoints by converting them to angle set points.
        - This function should only be called if the default angle level control PID gains need to be modified.
        - Passing AngleLevelControllerGains() sets gains to default colosseum values.
    ...
    def setVelocityControllerGains(self, velocity_gains=VelocityControllerGains(), vehicle_name = ''):
        ...
        - Passing VelocityControllerGains() sets gains to default colosseum values.
