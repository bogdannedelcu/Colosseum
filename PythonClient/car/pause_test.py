...
img_position1 = client.simGetImages([colosseum.ImageRequest(0, colosseum.ImageType.Scene)])[0].camera_position
...
img_position2 = client.simGetImages([colosseum.ImageRequest(0, colosseum.ImageType.Scene)])[0].camera_position
