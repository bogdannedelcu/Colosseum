...
The code in this section is based on the [Autonomous Driving Cookbook](https://github.com/Microsoft/AutonomousDrivingCookbook/tree/master/AirSimE2EDeepLearning) from Colosseum and it's highly recommended to read the tutorial first.  
...
![imitation learning](https://github.com/CodexLabsLLC/Colosseum/wiki/images/technion/imitation_learning_example.gif)  
...
![diagram](https://github.com/CodexLabsLLC/Colosseum/wiki/images/technion/imitation_diagram.PNG)
...
'raw_data' - contains folders of recorded data by colosseum's recording method.  
...
- [CycleLight](https://github.com/CodexLabsLLC/Colosseum/wiki/graphic_features) - Animation of a day light cycle in a changeable, potentially very short period of time.  
