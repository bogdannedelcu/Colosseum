...
Colosseum has code to write pfm file for [C++](https://github.com/CodexLabsLLC/Colosseum/blob/main/ColosseumLib/include/common/common_utils/Utils.hpp#L637) and read as well as write for [Python](https://github.com/CodexLabsLLC/Colosseum/tree/main/PythonClient//colosseum/utils.py#L122).
