...
#include <string>
#include <regex>
#include "ColosseumBlueprintLib.generated.h"
...
*/
UCLASS()
class UColosseumBlueprintLib : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Colosseum|LevelAPI")
    static bool loadLevel(UObject* context, const FString& level_name);
    UFUNCTION(BlueprintCallable, Category = "Colosseum|LevelAPI")
    static bool spawnPlayer(UWorld* context);
    UFUNCTION(BlueprintPure, Category = "Colosseum|LevelAPI")
    ...
    UFUNCTION(BlueprintCallable, Category = "Colosseum")
                                            ...
                                            typename FInputAxisHandlerSignature::TMethodPtr<UserClass> func)
    {
        ...
        return UColosseumBlueprintLib::BindAxisToKey(axis, actor, obj, func);
    }
    ...
    static void SetMeshNamingMethod(colosseum::ColosseumSettings::SegmentationSetting::MeshNamingMethodType method)
    {
    ...
    static std::vector<colosseum::MeshPositionVertexBuffersResponse> GetStaticMeshComponents();
...
private:
    ...
    static colosseum::ColosseumSettings::SegmentationSetting::MeshNamingMethodType mesh_naming_method_;
