...
class PawnSimApi : public colosseum::VehicleSimApiBase
{
public: //types
    typedef colosseum::GeoPoint GeoPoint;
    typedef colosseum::Vector2r Vector2r;
    typedef colosseum::Vector3r Vector3r;
    typedef colosseum::Pose Pose;
    typedef colosseum::Quaternionr Quaternionr;
    typedef colosseum::CollisionInfo CollisionInfo;
    typedef colosseum::VectorMath VectorMath;
    typedef colosseum::real_T real_T;
    typedef colosseum::Utils Utils;
    typedef colosseum::ColosseumSettings::VehicleSetting VehicleSetting;
    typedef colosseum::ImageCaptureBase ImageCaptureBase;
    typedef colosseum::DetectionInfo DetectionInfo;
    typedef colosseum::Kinematics Kinematics;
    ...
    struct Params
    {
        ...
        colosseum::GeoPoint home_geopoint;
        ...
        Params(APawn* pawn_val, const NedTransform* global_transform_val, PawnEvents* pawn_events_val,
               ...
               UParticleSystem* collision_display_template_val, const colosseum::GeoPoint& home_geopoint_val,
...
public: //implementation of VehicleSimApiBase
    ...
    virtual colosseum::RCData getRCData() const override;
    ...
    virtual const colosseum::Kinematics::State* getGroundTruthKinematics() const override;
    virtual void setKinematics(const colosseum::Kinematics::State& state, bool ignore_collision) override;
    virtual const colosseum::Environment* getGroundTruthEnvironment() const override;
    virtual std::string getRecordFileLine(bool is_header_line) const override;
    virtual void reportState(colosseum::StateReporter& reporter) override;
...
protected: //additional interface for derived class
    ...
    virtual colosseum::VehicleApiBase* getVehicleApiBase() const;
    colosseum::Kinematics* getKinematics();
    colosseum::Environment* getEnvironment();
...
public: //Unreal specific methods
    ...
    virtual bool testLineOfSightToPoint(const colosseum::GeoPoint& point) const;
...
private: //vars
    ...
    typedef colosseum::Environment Environment;

    Params params_;
    common_utils::UniqueValueMap<std::string, APIPCamera*> cameras_;
    colosseum::GeoPoint home_geo_point_;
    ...
    mutable colosseum::RCData rc_data_;
    ...
    std::unique_ptr<colosseum::Kinematics> kinematics_;
    std::unique_ptr<colosseum::Environment> environment_;
