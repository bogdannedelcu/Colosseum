...
UCLASS()
class COLOSSEUM_API ASimHUD : public AHUD
{
    GENERATED_BODY()
...
private:
    ...
    const std::vector<ColosseumSettings::SubwindowSetting>& getSubWindowSettings() const;
    std::vector<ColosseumSettings::SubwindowSetting>& getSubWindowSettings();
...
private:
    ...
    APIPCamera* subwindow_cameras_[ColosseumSettings::kSubwindowCount];
    bool map_changed_;
};
