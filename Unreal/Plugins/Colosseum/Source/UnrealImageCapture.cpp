...
void UnrealImageCapture::getImages(const std::vector<colosseum::ImageCaptureBase::ImageRequest>& requests,
                                   std::vector<colosseum::ImageCaptureBase::ImageResponse>& responses) const
{
...
void UnrealImageCapture::getSceneCaptureImage(const std::vector<colosseum::ImageCaptureBase::ImageRequest>& requests,
                                              std::vector<colosseum::ImageCaptureBase::ImageResponse>& responses, bool use_safe_method) const
{
    ...
    for (unsigned int i = 0; i < requests.size(); ++i) {
        ...
        if (use_safe_method) {
            ...
            APIPCamera* camera = cameras_->at(request.camera_name);
            colosseum::Pose pose = camera->getPose();
...
bool UnrealImageCapture::updateCameraVisibility(APIPCamera* camera, const colosseum::ImageCaptureBase::ImageRequest& request)
{
    bool visibilityChanged = false;
