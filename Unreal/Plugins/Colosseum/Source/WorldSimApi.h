...
class WorldSimApi : public colosseum::WorldSimApiBase
{
public:
    typedef colosseum::Pose Pose;
    typedef colosseum::Vector3r Vector3r;
    typedef colosseum::MeshPositionVertexBuffersResponse MeshPositionVertexBuffersResponse;
    typedef colosseum::ImageCaptureBase ImageCaptureBase;
    typedef colosseum::CameraDetails CameraDetails;
    ...
    virtual bool testLineOfSightBetweenPoints(const colosseum::GeoPoint& point1, const colosseum::GeoPoint& point2) const override;
    virtual std::vector<colosseum::GeoPoint> getWorldExtents() const override;

    // Camera APIs
    virtual colosseum::CameraInfo getCameraInfo(const CameraDetails& camera_details) const override;
    virtual void setCameraPose(const colosseum::Pose& pose, const CameraDetails& camera_details) override;
    ...
    virtual std::vector<colosseum::DetectionInfo> getDetections(ImageCaptureBase::ImageType image_type, const CameraDetails& camera_details) override;
