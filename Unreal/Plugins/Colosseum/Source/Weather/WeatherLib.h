...
class COLOSSEUM_API UWeatherLib : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
    ...
    {
        return TEXT("/Colosseum/Weather/WeatherFX/WeatherGlobalParams");
    }
    static const FSoftClassPath getWeatherMenuObjectPath()
    {
        return FSoftClassPath(TEXT("AActor'/Colosseum/Weather/UI/MenuActor.MenuActor_C'"));
    }

    static const FSoftClassPath getWeatherActorPath()
    {
        return FSoftClassPath(TEXT("AActor'/Colosseum/Weather/WeatherFX/WeatherActor.WeatherActor_C'"));
    }

    static const FSoftClassPath getWeatherMenuWidgetClass()
    {
        return FSoftClassPath(TEXT("UUserWidget'/Colosseum/HUDAssets/OptionsMenu.OptionsMenu_C'"));
    }
