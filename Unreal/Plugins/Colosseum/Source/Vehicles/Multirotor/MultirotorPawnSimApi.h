...
public:
    ...
    typedef colosseum::MultiRotorPhysicsBody MultiRotor;
...
public:
    ...
    colosseum::MultirotorApiBase* getVehicleApi() const
    {
...
private:
    std::unique_ptr<colosseum::MultirotorApiBase> vehicle_api_;
    std::unique_ptr<colosseum::MultiRotorParams> vehicle_params_;
    ...
    colosseum::CollisionResponse collision_response;
    ...
    colosseum::RotorStates rotor_states_;
};
