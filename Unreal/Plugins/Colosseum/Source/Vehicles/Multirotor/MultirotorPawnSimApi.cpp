...
void MultirotorPawnSimApi::updateRendering(float dt)
{
    ...
    //UColosseumBlueprintLib::LogMessage(TEXT("Collision (raw) Count:"), FString::FromInt(collision_response.collision_count_raw), LogDebugLevel::Unimportant);
    UColosseumBlueprintLib::LogMessage(TEXT("Collision Count:"),
