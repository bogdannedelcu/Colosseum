...
void ACameraManager::Tick(float DeltaTime)
{
    ...
    if (mode_ == ECameraDirectorMode::CAMERA_DIRECTOR_MODE_MANUAL) {
        ...
        UColosseumBlueprintLib::FollowActor(ExternalCamera, follow_actor_, initial_ground_obs_offset_, ext_obs_fixed_z_);
    }
}
...
void ACameraManager::setMode(ECameraDirectorMode mode)
{
    { //first remove any settings done by previous mode
        ...
        if (mode_ == ECameraDirectorMode::CAMERA_DIRECTOR_MODE_NODISPLAY &&
            ...
            UColosseumBlueprintLib::enableViewportRendering(this, true);
        }
    ...
    { //perform any settings to enter in to this mode
        ...
        case ECameraDirectorMode::CAMERA_DIRECTOR_MODE_SPRINGARM_CHASE:
            ...
            break;
        case ECameraDirectorMode::CAMERA_DIRECTOR_MODE_NODISPLAY:
            UColosseumBlueprintLib::enableViewportRendering(this, false);
            break;
        default:
...
void ACameraManager::setupInputBindings()
{
    ...
    UColosseumBlueprintLib::BindActionToKey("inputEventFpvView", EKeys::F, this, &ACameraManager::inputEventFpvView);
    UColosseumBlueprintLib::BindActionToKey("inputEventFlyWithView", EKeys::B, this, &ACameraManager::inputEventFlyWithView);
    UColosseumBlueprintLib::BindActionToKey("inputEventGroundView", EKeys::Backslash, this, &ACameraManager::inputEventGroundView);
    UColosseumBlueprintLib::BindActionToKey("inputEventManualView", EKeys::M, this, &ACameraManager::inputEventManualView);
    UColosseumBlueprintLib::BindActionToKey("inputEventSpringArmChaseView", EKeys::Slash, this, &ACameraManager::inputEventSpringArmChaseView);
    UColosseumBlueprintLib::BindActionToKey("inputEventBackupView", EKeys::K, this, &ACameraManager::inputEventBackupView);
    UColosseumBlueprintLib::BindActionToKey("inputEventNoDisplayView", EKeys::Hyphen, this, &ACameraManager::inputEventNoDisplayView);
    UColosseumBlueprintLib::BindActionToKey("inputEventFrontView", EKeys::I, this, &ACameraManager::inputEventFrontView);
}
...
void ACameraManager::inputEventSpringArmChaseView()
{
    if (ExternalCamera) {
        ...
        UColosseumBlueprintLib::LogMessageString("Camera is not available: ", "ExternalCamera", LogDebugLevel::Failure);
...
void ACameraManager::inputEventBackupView()
{
    if (backup_camera_) {
        ...
        UColosseumBlueprintLib::LogMessageString("Camera is not available: ", "backup_camera", LogDebugLevel::Failure);
...
void ACameraManager::inputEventFpvView()
{
    if (fpv_camera_) {
        ...
        UColosseumBlueprintLib::LogMessageString("Camera is not available: ", "fpv_camera", LogDebugLevel::Failure);
