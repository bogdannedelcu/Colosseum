...
# todo expose colosseumsettings.hpp via pybind11? this should be done for the full API *some*day
class Position():
...
class JSONSettingsCreator(object):
    ...
    def add_minimal(self):
        self.data["SeeDocsAt"] = "https://github.com/CodexLabsLLC/Colosseum/blob/main/docs/settings.md"
