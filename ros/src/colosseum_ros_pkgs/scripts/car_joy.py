...
#capture joystick events using ROS and convert to Colosseum Car API commands
#to enable:
# rosrun joy joy_node
...
import colosseum_ros_pkgs as air
import colosseum_ros_pkgs.msg
...
class CarCommandTranslator(object):
    def __init__(self):
        ...
        car_control_topic = rospy.get_param('~car_control_topic', '/colosseum_node/drone_1/car_cmd')
    ...
    def handle_update_timer(self, ignored):
        ...
        controls = colosseum_ros_pkgs.msg.CarControls()
