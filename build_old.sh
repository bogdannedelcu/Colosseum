...
if [ ! -d "./external/rpclib/$RPC_VERSION_FOLDER" ]; then
    echo "ERROR: new version of Colosseum requires newer rpclib."
...
if [ "$(uname)" == "Darwin" ]; then
    ...
    # https://github.com/CodexLabsLLC/Colosseum/issues/3691
...
if [[ ! -d "./ColosseumLib/deps/eigen3/Eigen" ]]; then
...
rsync -a --delete $build_dir/output/lib/ ColosseumLib/lib/x64/$folder_name
...
#     $d/clean.sh
#     mkdir -p $d/Plugins
#     rsync -a --delete Unreal/Plugins/Colosseum $d/Plugins
# done
...
echo "https://github.com/CodexLabsLLC/Colosseum/blob/master/docs/build_linux.md"
echo "=================================================================="
