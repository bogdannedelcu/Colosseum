...
#ifndef msr_colosseum_MultiRotorParameters_hpp
#define msr_colosseum_MultiRotorParameters_hpp
...
namespace colosseum
{
    ...
    public: //interface
        ...
        virtual void initialize(const ColosseumSettings::VehicleSetting* vehicle_setting)
        {
