...
#ifndef msr_colosseum_vehicles_Px4MultiRotor_hpp
#define msr_colosseum_vehicles_Px4MultiRotor_hpp
...
namespace colosseum
{
    ...
    {
    public:
        Px4MultiRotorParams(const ColosseumSettings::MavLinkVehicleSetting& vehicle_setting, std::shared_ptr<const SensorFactory> sensor_factory)
