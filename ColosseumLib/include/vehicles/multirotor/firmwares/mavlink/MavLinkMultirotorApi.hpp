...
#ifndef msr_colosseum_MavLinkDroneController_hpp
#define msr_colosseum_MavLinkDroneController_hpp
...
namespace colosseum
{
    ...
    public: //methods
        ...
        void initialize(const ColosseumSettings::MavLinkConnectionInfo& connection_info, const SensorCollection* sensors, bool is_simulation)
        {
        ...
        virtual void update() override
        {
            try {
                ...
                disconnect();
                connect(); // re-start a new connection so PX4 can be restarted and Colosseum will happily continue on.
            }
    ...
    private: //methods
        ...
        void createMavConnection(const ColosseumSettings::MavLinkConnectionInfo& connection_info)
        {
        ...
        void createMavEthernetConnection(const ColosseumSettings::MavLinkConnectionInfo& connection_info)
        {
            close();
