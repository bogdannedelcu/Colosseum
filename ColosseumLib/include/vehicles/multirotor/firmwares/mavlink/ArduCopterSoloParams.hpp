...
#ifndef msr_colosseum_vehicles_ArduCopterSolo_hpp
#define msr_colosseum_vehicles_ArduCopterSolo_hpp
...
namespace colosseum
{
    ...
    public:
        ArduCopterSoloParams(const ColosseumSettings::MavLinkVehicleSetting& vehicle_settings, std::shared_ptr<const SensorFactory> sensor_factory)
    ...
    private:
        ...
        {
            ColosseumSettings::MavLinkConnectionInfo result = vehicle_setting.connection_info;
            return result;
        }
