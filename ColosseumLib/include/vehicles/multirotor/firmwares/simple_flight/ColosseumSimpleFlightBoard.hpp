...
#ifndef msr_colosseum_ColosseumSimpleFlightBoard_hpp
#define msr_colosseum_ColosseumSimpleFlightBoard_hpp
...
namespace colosseum
{
    ...
    class ColosseumSimpleFlightBoard : public simple_flight::IBoard
    {
    public:
        ColosseumSimpleFlightBoard(const simple_flight::Params* params)
            : params_(params)
        {
        }
