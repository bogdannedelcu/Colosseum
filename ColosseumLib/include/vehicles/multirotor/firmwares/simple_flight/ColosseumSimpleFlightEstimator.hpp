...
#ifndef msr_colosseum_ColosseumSimpleFlightEstimator_hpp
#define msr_colosseum_ColosseumSimpleFlightEstimator_hpp
...
namespace colosseum
{
    ...
    class ColosseumSimpleFlightEstimator : public simple_flight::IStateEstimator
    {
    public:
        virtual ~ColosseumSimpleFlightEstimator() {}
        ...
        {
            return ColosseumSimpleFlightCommon::toAxis3r(kinematics_->pose.position);
        }

        virtual simple_flight::Axis3r transformToBodyFrame(const simple_flight::Axis3r& world_frame_val) const override
        {
            const Vector3r& vec = ColosseumSimpleFlightCommon::toVector3r(world_frame_val);
            const Vector3r& trans = VectorMath::transformToBodyFrame(vec, kinematics_->pose.orientation);
            return ColosseumSimpleFlightCommon::toAxis3r(trans);
        }

        virtual simple_flight::Axis3r getLinearVelocity() const override
        {
            return ColosseumSimpleFlightCommon::toAxis3r(kinematics_->twist.linear);
        }

        virtual simple_flight::Axis4r getOrientation() const override
        {
            return ColosseumSimpleFlightCommon::toAxis4r(kinematics_->pose.orientation);
        }

        virtual simple_flight::GeoPoint getGeoPoint() const override
        {
            return ColosseumSimpleFlightCommon::toSimpleFlightGeoPoint(environment_->getState().geo_point);
        }

        virtual simple_flight::GeoPoint getHomeGeoPoint() const override
        {
            return ColosseumSimpleFlightCommon::toSimpleFlightGeoPoint(environment_->getHomeGeoPoint());
        }
        ...
        virtual simple_flight::KinematicsState getKinematicsEstimated() const override
        {
            ...
            state.linear_acceleration = ColosseumSimpleFlightCommon::toAxis3r(kinematics_->accelerations.linear);
            state.angular_acceleration = ColosseumSimpleFlightCommon::toAxis3r(kinematics_->accelerations.angular);
