...
#ifndef msr_colosseum_SimpleFlightDroneController_hpp
#define msr_colosseum_SimpleFlightDroneController_hpp
...
#include "ColosseumSimpleFlightBoard.hpp"
#include "ColosseumSimpleFlightCommLink.hpp"
#include "ColosseumSimpleFlightEstimator.hpp"
#include "ColosseumSimpleFlightCommon.hpp"
...
namespace colosseum
{
    ...
    public:
        SimpleFlightApi(const MultiRotorParams* vehicle_params, const ColosseumSettings::VehicleSetting* vehicle_setting)
            : vehicle_params_(vehicle_params)
        {
            ...
            board_.reset(new ColosseumSimpleFlightBoard(&params_));
            comm_link_.reset(new ColosseumSimpleFlightCommLink());
            estimator_.reset(new ColosseumSimpleFlightEstimator());
    ...
    public: //VehicleApiBase implementation
        ...
        {
            return ColosseumSimpleFlightCommon::toGeoPoint(firmware_->offboardApi().getHomeGeoPoint());
        }
    ...
    protected:
        ...
        {
            return ColosseumSimpleFlightCommon::toKinematicsState3r(firmware_->offboardApi().getStateEstimator().getKinematicsEstimated());
        }

        virtual Vector3r getPosition() const override
        {
            const auto& val = firmware_->offboardApi().getStateEstimator().getPosition();
            return ColosseumSimpleFlightCommon::toVector3r(val);
        }
        ...
        virtual Quaternionr getOrientation() const override
        {
            ...
            return ColosseumSimpleFlightCommon::toQuaternion(val);
        }
        ...
        {
            return ColosseumSimpleFlightCommon::toGeoPoint(firmware_->offboardApi().getGeoPoint());
        }
    ...
    private:
        ...
        void readSettings(const ColosseumSettings::VehicleSetting& vehicle_setting)
        {
    ...
    private:
        ...
        unique_ptr<ColosseumSimpleFlightBoard> board_;
        unique_ptr<ColosseumSimpleFlightCommLink> comm_link_;
        unique_ptr<ColosseumSimpleFlightEstimator> estimator_;
