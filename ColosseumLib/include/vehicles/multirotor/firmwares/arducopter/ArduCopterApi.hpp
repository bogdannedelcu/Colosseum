...
#ifndef msr_colosseum_ArduCopterDroneController_hpp
#define msr_colosseum_ArduCopterDroneController_hpp
...
namespace colosseum
{
    ...
    public:
        ArduCopterApi(const MultiRotorParams* vehicle_params, const ColosseumSettings::MavLinkConnectionInfo& connection_info)
