...
#ifndef msr_colosseum_PhysXCarController_hpp
#define msr_colosseum_PhysXCarController_hpp
...
namespace colosseum
{
    ...
    {
    public:
        PhysXCarApi(const ColosseumSettings::VehicleSetting* vehicle_setting, std::shared_ptr<SensorFactory> sensor_factory,
