...
#ifndef msr_colosseum_ArduRoverCarController_hpp
#define msr_colosseum_ArduRoverCarController_hpp
...
namespace colosseum
{
    ...
    public:
        ArduRoverApi(const ColosseumSettings::VehicleSetting* vehicle_setting, std::shared_ptr<SensorFactory> sensor_factory,
                     const Kinematics::State& state, const Environment& environment)
            : CarApiBase(vehicle_setting, sensor_factory, state, environment), home_geopoint_(environment.getHomeGeoPoint())
        {
            connection_info_ = static_cast<const ColosseumSettings::MavLinkVehicleSetting*>(vehicle_setting)->connection_info;
            sensors_ = &getSensors();
    ...
    public:
        ...
        {
            // Currently ArduPilot vehicles don't implement Colosseum movement APIs
            unused(controls);
        }
