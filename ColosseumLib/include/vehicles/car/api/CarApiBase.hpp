...
#ifndef colosseum_CarApiBase_hpp
#define colosseum_CarApiBase_hpp
...
namespace colosseum
{
    ...
    public:
        ...
        CarApiBase(const ColosseumSettings::VehicleSetting* vehicle_setting,
        ...
        void initialize(const ColosseumSettings::VehicleSetting* vehicle_setting,
                        std::shared_ptr<SensorFactory> sensor_factory,
                        const Kinematics::State& state, const Environment& environment)
        {
        ...
        void addSensorsFromSettings(const ColosseumSettings::VehicleSetting* vehicle_setting)
        {
