...
#ifndef colosseum_core_ColosseumSettings_hpp
#define colosseum_core_ColosseumSettings_hpp
...
namespace colosseum
{
    ...
    public: //types
        ...
        struct PawnPath
        {
            ...
            PawnPath(const std::string& pawn_bp_val = "",
                     const std::string& slippery_mat_val = "/Colosseum/VehicleAdv/PhysicsMaterials/Slippery.Slippery",
                     const std::string& non_slippery_mat_val = "/Colosseum/VehicleAdv/PhysicsMaterials/NonSlippery.NonSlippery")
        ...
        struct CaptureSetting
        {
            ...
            //TODO: should we use UColosseumBlueprintLib::GetDisplayGamma()?
        ...
        struct MavLinkConnectionInfo
        {
            ...
            // The QGroundControl app can be on a different machine, and Colosseum can act as a proxy to forward
    ...
    public: //methods
        static ColosseumSettings& singleton()
        {
            static ColosseumSettings instance;
            return instance;
        }
        ...
        static void createDefaultSettingsFile()
        {
            ...
            settings_json.setString("SeeDocsAt", "https://github.com/CodexLabsLLC/Colosseum/blob/main/docs/settings.md");
    ...
    private:
            ...
            if (upgrade_required) {
                    ...
                    if (settings_version_actual == 1) {
                        ...
                        if (detected_keys.length()) {
                            std::string error_message =
                                "You are using newer version of Colosseum with older version of settings.json. "
                                "You can either delete your settings.json and restart Colosseum or use the upgrade "
                ...
                if (auto_upgrade) {
                    warning_messages.push_back(
                        "You are using newer version of Colosseum with older version of settings.json. "
                        "You should delete your settings.json file and restart Colosseum.");
                }
            }
                                        ...
                                        const CameraSetting& camera_defaults)
        {
            ...
            colosseum::Settings vehicles_child;
        ...
        static void initializePawnPaths(std::map<std::string, PawnPath>& pawn_paths)
        {
            ...
            pawn_paths.emplace("BareboneCar",
                               PawnPath("Class'/Colosseum/VehicleAdv/Vehicle/VehicleAdvPawn.VehicleAdvPawn_C'"));
            pawn_paths.emplace("DefaultCar",
                               PawnPath("Class'/Colosseum/VehicleAdv/SUV/SuvCarPawn.SuvCarPawn_C'"));
            pawn_paths.emplace("DefaultQuadrotor",
                               PawnPath("Class'/Colosseum/Blueprints/BP_FlyingPawn.BP_FlyingPawn_C'"));
            pawn_paths.emplace("DefaultComputerVision",
                               PawnPath("Class'/Colosseum/Blueprints/BP_ComputerVisionPawn.BP_ComputerVisionPawn_C'"));
        }
        ...
        static void loadPawnPaths(const Settings& settings_json, std::map<std::string, PawnPath>& pawn_paths)
        {
            ...
            colosseum::Settings pawn_paths_child;
        ...
        static void loadUnrealEngineSetting(const colosseum::Settings& settings_json, UnrealEngineSetting& ue_setting)
        {
        ...
        static void createCaptureSettings(const colosseum::Settings& settings_json, CaptureSetting& capture_setting)
        {
...

        {
            ...
            colosseum::Settings sensors_child;
