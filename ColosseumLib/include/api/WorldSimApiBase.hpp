...
#ifndef colosseum_WorldSimApiBase_hpp
#define colosseum_WorldSimApiBase_hpp
...
namespace colosseum
{
    ...
    public:
        ...
        virtual bool testLineOfSightBetweenPoints(const colosseum::GeoPoint& point1, const colosseum::GeoPoint& point2) const = 0;
        virtual vector<colosseum::GeoPoint> getWorldExtents() const = 0;

        // Camera APIs
        virtual CameraInfo getCameraInfo(const CameraDetails& camera_details) const = 0;
        virtual void setCameraPose(const colosseum::Pose& pose, const CameraDetails& camera_details) = 0;
