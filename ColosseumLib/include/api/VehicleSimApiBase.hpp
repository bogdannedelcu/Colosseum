...
#ifndef colosseum_VehicleSimApiBase_hpp
#define colosseum_VehicleSimApiBase_hpp
...
namespace colosseum
{
    ...
    class VehicleSimApiBase : public colosseum::UpdatableObject
    {
    public:
        ...
        virtual const colosseum::Environment* getGroundTruthEnvironment() const = 0;
        ...
        const ColosseumSettings::VehicleSetting* getVehicleSetting() const
        {
            return ColosseumSettings::singleton().getVehicleSetting(getVehicleName());
        }
    };
}
#endif
