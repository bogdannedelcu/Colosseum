...
#ifndef colosseum_RpcLibClientBase_hpp
#define colosseum_RpcLibClientBase_hpp
...
namespace colosseum
{
    ...
    public:
        ...
        colosseum::GeoPoint getHomeGeoPoint(const std::string& vehicle_name = "") const;

        bool simRunConsoleCommand(const std::string& command);

        // sensor APIs
        colosseum::LidarData getLidarData(const std::string& lidar_name = "", const std::string& vehicle_name = "") const;
        colosseum::ImuBase::Output getImuData(const std::string& imu_name = "", const std::string& vehicle_name = "") const;
        colosseum::BarometerBase::Output getBarometerData(const std::string& barometer_name = "", const std::string& vehicle_name = "") const;
        colosseum::MagnetometerBase::Output getMagnetometerData(const std::string& magnetometer_name = "", const std::string& vehicle_name = "") const;
        colosseum::GpsBase::Output getGpsData(const std::string& gps_name = "", const std::string& vehicle_name = "") const;
        colosseum::DistanceSensorData getDistanceSensorData(const std::string& distance_sensor_name = "", const std::string& vehicle_name = "") const;
        ...
        //end CinemColosseum
        bool simTestLineOfSightToPoint(const colosseum::GeoPoint& point, const std::string& vehicle_name = "");
        bool simTestLineOfSightBetweenPoints(const colosseum::GeoPoint& point1, const colosseum::GeoPoint& point2);
        vector<colosseum::GeoPoint> simGetWorldExtents();
        ...
        colosseum::Kinematics::State simGetGroundTruthKinematics(const std::string& vehicle_name = "") const;
        void simSetKinematics(const Kinematics::State& state, bool ignore_collision, const std::string& vehicle_name = "");
        colosseum::Environment::State simGetGroundTruthEnvironment(const std::string& vehicle_name = "") const;
