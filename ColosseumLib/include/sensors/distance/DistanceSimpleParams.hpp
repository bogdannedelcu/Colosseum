...
#ifndef msr_colosseum_DistanceSimpleParams_hpp
#define msr_colosseum_DistanceSimpleParams_hpp
...
*/
        ...
        void initializeFromSettings(const ColosseumSettings::DistanceSetting& settings)
        {
            ...
            auto position = ColosseumSettings::createVectorSetting(settings_json, VectorMath::nanVector());
