...
#ifndef msr_colosseum_Distance_hpp
#define msr_colosseum_Distance_hpp
...
namespace colosseum
{
    ...
    {
    public:
        DistanceSimple(const ColosseumSettings::DistanceSetting& setting = ColosseumSettings::DistanceSetting())
