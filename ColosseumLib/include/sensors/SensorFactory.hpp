#ifndef msr_colosseum_SensorFactoryBase_hpp
#define msr_colosseum_SensorFactoryBase_hpp
    ...
    public:
            ...
            const ColosseumSettings::SensorSetting* sensor_setting) const
        {
            ...
            case SensorBase::SensorType::Imu:
                return std::shared_ptr<ImuSimple>(new ImuSimple(*static_cast<const ColosseumSettings::ImuSetting*>(sensor_setting)));
            case SensorBase::SensorType::Magnetometer:
                return std::shared_ptr<MagnetometerSimple>(new MagnetometerSimple(*static_cast<const ColosseumSettings::MagnetometerSetting*>(sensor_setting)));
            case SensorBase::SensorType::Gps:
                return std::shared_ptr<GpsSimple>(new GpsSimple(*static_cast<const ColosseumSettings::GpsSetting*>(sensor_setting)));
            case SensorBase::SensorType::Barometer:
                return std::shared_ptr<BarometerSimple>(new BarometerSimple(*static_cast<const ColosseumSettings::BarometerSetting*>(sensor_setting)));
            default:
        ...
        virtual void createSensorsFromSettings(
            const std::map<std::string, std::shared_ptr<ColosseumSettings::SensorSetting>>& sensors_settings,
            SensorCollection& sensors,
            vector<shared_ptr<SensorBase>>& sensor_storage) const
        {
            for (const auto& sensor_setting_pair : sensors_settings) {
                const ColosseumSettings::SensorSetting* sensor_setting = sensor_setting_pair.second.get();
