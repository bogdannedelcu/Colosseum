...
#ifndef msr_colosseum_GpsSimpleParams_hpp
#define msr_colosseum_GpsSimpleParams_hpp
...
namespace colosseum
{
    ...
    struct GpsSimpleParams
    {
        ...
        void initializeFromSettings(const ColosseumSettings::GpsSetting& settings)
        {
