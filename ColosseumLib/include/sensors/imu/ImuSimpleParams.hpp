...
#ifndef msr_colosseum_SimpleImuParams_hpp
#define msr_colosseum_SimpleImuParams_hpp
...
namespace colosseum
{
    ...
    */
        ...
        void initializeFromSettings(const ColosseumSettings::ImuSetting& settings)
        {
