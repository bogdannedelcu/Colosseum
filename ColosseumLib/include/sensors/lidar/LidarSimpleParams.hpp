...
#ifndef msr_colosseum_LidarSimpleParams_hpp
#define msr_colosseum_LidarSimpleParams_hpp
...
namespace colosseum
{
    ...
    struct LidarSimpleParams
    {
        ...
        // default settings
        // TODO: enable reading of these params from Colosseum settings
        ...
        ColosseumSettings::LidarSetting::DataFrame data_frame;
        ...
        void initializeFromSettings(const ColosseumSettings::LidarSetting& settings)
        {
            ...
            std::string frame = settings_json.getString("DataFrame", ColosseumSettings::kVehicleInertialFrame);
            if (frame == ColosseumSettings::kVehicleInertialFrame) {
                data_frame = ColosseumSettings::LidarSetting::DataFrame::VehicleInertialFrame;
            }
            else if (frame == ColosseumSettings::kSensorLocalFrame) {
                data_frame = ColosseumSettings::LidarSetting::DataFrame::SensorLocalFrame;
            }
            else {
            ...
            relative_pose.position = ColosseumSettings::createVectorSetting(settings_json, VectorMath::nanVector());
            auto rotation = ColosseumSettings::createRotationSetting(settings_json, ColosseumSettings::Rotation::nanRotation());
