...
#ifndef msr_colosseum_Barometer_hpp
#define msr_colosseum_Barometer_hpp
...
namespace colosseum
{
    ...
    {
    public:
        BarometerSimple(const ColosseumSettings::BarometerSetting& setting = ColosseumSettings::BarometerSetting())
