...
#ifndef msr_colosseum_BarometerSimpleParams_hpp
#define msr_colosseum_BarometerSimpleParams_hpp
...
namespace colosseum
{
    ...
    */
        ...
        void initializeFromSettings(const ColosseumSettings::BarometerSetting& settings)
        {
