...
#ifndef msr_colosseum_MagnetometerSimpleParams_hpp
#define msr_colosseum_MagnetometerSimpleParams_hpp
...
namespace colosseum
{
    ...
    struct MagnetometerSimpleParams
    {
        ...
        void initializeFromSettings(const ColosseumSettings::MagnetometerSetting& settings)
        {
