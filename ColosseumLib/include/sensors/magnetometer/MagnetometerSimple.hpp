...
#ifndef msr_colosseum_MagnetometerSimple_hpp
#define msr_colosseum_MagnetometerSimple_hpp
...
namespace colosseum
{
    ...
    {
    public:
        MagnetometerSimple(const ColosseumSettings::MagnetometerSetting& setting = ColosseumSettings::MagnetometerSetting())
